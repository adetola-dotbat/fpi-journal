                                ...
                                <form action="{{ route('admin.update.article', $article->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Page number" name="pages"
                                            value="{{ $article->pages }}" class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label class="form-label">Author(s)</label>
                                        <input type="text" placeholder="Author" name="author"
                                            value="{{ $article->author }}" class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label class="form-label">Abstract</label>
                                        <div class="form-control-wrap">
                                            <textarea class="form-control form-control-sm" name="abstract" placeholder="Write your message">{{ $article->abstract }}</textarea>
                                        </div>
                                    </div>
