...
<body x-data="main"
    class="antialiased relative font-inter bg-white text-black text-sm font-normal overflow-x-hidden vertical"
    ...
    <div class="main-container navbar-sticky flex" :class="[$store.app.navbar]">
        ...
        <div
            class="right-sidebar fixed right-0 bg-white bottom-0 z-50 w-[280px] border-l border-black/10 transition-all duration-300">
            <div class="flex flex-col gap-9 px-6 py-[22px] h-screen overflow-y-auto overflow-x-hidden">
                <div>
                    <h4 class="font-semibold text-black mb-5">Notifications</h4>
                    <div class="flex flex-col gap-4">
                        <div class="flex gap-2">
                            ...
                            <div class="flex-1">
                                <p class="whitespace-nowrap overflow-hidden text-ellipsis w-[200px] text-black">
                                    You have a bug that needs to be fixed.</p>
                                <p class="text-xs text-black/40">5m ago</p>
                            </div>
                        </div>
                        <div class="flex gap-2">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-black/40">1:23 AM</p>
                            </div>
                        </div>
                        <div class="flex gap-2">
                            <div class="h-6 w-6 flex-none p-1 text-black bg-lightblue-100 rounded-lg">
                            ...
                            <div class="flex-1">
                                <p class="whitespace-nowrap overflow-hidden text-ellipsis w-[200px] text-black">
                                    You have a bug that needs to be fixed.</p>
                                <p class="text-xs text-black/40">0:32 AM</p>
                            </div>
                        </div>
                        <div class="flex gap-2">
                            <div class="h-6 w-6 flex-none p-1 text-black bg-lightpurple-100 rounded-lg">
                                <svg width="32" height="32" class="w-4 h-4" viewbox="0 0 32 32"
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-black/40">Yesterday 12:39 AM</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div>
                    <h4 class="font-semibold text-black mb-5">Activities</h4>
                    <div class="flex flex-col gap-4">
                        <div class="flex gap-2">
                        ...
                        <div class="flex gap-2">
                            ...
                            <div class="flex-1">
                                <p class="whitespace-nowrap overflow-hidden text-ellipsis w-[200px] text-black">
                                    Modified A data in Page X</p>
                                <p class="text-xs text-black/40">Last Thursday 3:34 AM</p>
                            </div>
                        </div>
                        <div class="flex gap-2">
                            <div class="h-6 w-6 flex-none rounded-full overflow-hidden">
                            ...
                            <div class="flex-1">
                                <p class="whitespace-nowrap overflow-hidden text-ellipsis w-[200px] text-black">
                                    Deleted a page in Project X</p>
                                <p class="text-xs text-black/40">Aug 11</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div>
                    <h4 class="font-semibold text-black mb-5">Contacts</h4>
                    <div class="flex flex-col gap-4">
                        <div class="flex gap-2 items-center">
                            <img src="assets/images/avatar-6.png" class="h-6 w-6 flex-none rounded-full object-cover"
                                alt="avatar" />
                            <p class="text-black">Natali Craig</p>
                        </div>
                        <div class="flex gap-2 items-center">
                            <img src="assets/images/avatar-7.png" class="h-6 w-6 flex-none rounded-full object-cover"
                                alt="avatar" />
                            <p class="text-black">Drew Cano</p>
                        </div>
                        <div class="flex gap-2 items-center">
                            <img src="assets/images/avatar-8.png" class="h-6 w-6 flex-none rounded-full object-cover"
                                alt="avatar" />
                            <p class="text-black">Orlando Diggs</p>
                        </div>
                        <div class="flex gap-2 items-center">
                            <img src="assets/images/avatar-9.png" class="h-6 w-6 flex-none rounded-full object-cover"
                                alt="avatar" />
                            <p class="text-black">Andi Lane</p>
                        </div>
                        <div class="flex gap-2 items-center">
                            <img src="assets/images/avatar-10.png" class="h-6 w-6 flex-none rounded-full object-cover"
                                alt="avatar" />
                            <p class="text-black">Kate Morrison</p>
                        </div>
                        <div class="flex gap-2 items-center">
                            <img src="assets/images/avatar-11.png" class="h-6 w-6 flex-none rounded-full object-cover"
                                alt="avatar" />
                            <p class="text-black">Koray Okumus</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript" src="{{ asset('administration/assets/bundles/plugins/jquery/jquery-3.3.1.min.js') }}">
    </script>
    <script data-cfasync="false" src=" {{ asset('administration/assets/js/email-decode.min.js') }} "></script>
    <script src="{{ asset('administration/assets/js/alpine-collaspe.min.js') }}"></script>
    <script src="{{ asset('administration/assets/js/alpine-persist.min.js') }}"></script>
    <script src="{{ asset('administration/assets/js/alpine.min.js') }}" defer></script>
    <script src="{{ asset('administration/assets/js/apexcharts.js') }}"></script>
    <script src="{{ asset('administration/assets/js/apexcharts-project.js') }}"></script>
