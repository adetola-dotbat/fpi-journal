<nav
    class="sidebar fixed top-0 bottom-0 z-40 flex-none w-[212px] border-r border-black/10 transition-all duration-300">
    <div class="bg-white h-full">

        <div class="flex p-4">
            <a href="index.html" class="main-logo flex-1 w-full">
                <img src="{{ asset('administration/assets/images/logo.svg') }} " alt="logo" class="block" />
                <img src="{{ asset('administration/assets/images/dark-logo.svg') }} " alt="logo"
                    class="hidden" />
            </a>
        </div>
        ...
        <ul class="relative h-[calc(100vh-58px)] flex flex-col gap-1 overflow-y-auto overflow-x-hidden p-4 py-0">
            <li class="menu nav-item">
                <a href="{{ route('admin.dashboard') }}" class="nav-link group"
                    ...
                    <div class="flex pl-5 items-center">
                        ...
                        <span class="pl-1 text-black">Dashboard</span>
                    </div>
                </a>
            </li>
            <li class="menu nav-item">
                <a href="{{ route('admin.about') }}" class="nav-link group"
                    ...
                    <div class="flex pl-5 items-center">
                        ...
                        <span class="pl-1 text-black">About</span>
                    </div>
                </a>
            </li>
            <li class="menu nav-item">
                <a href="{{ route('admin.call.for.papers') }}" class="nav-link group"
                    :class="{'active' : activeMenu === 'about'}">
                    <div class="flex pl-5 items-center">
                        <svg class="w-5 h-5" width="32" height="32" viewbox="0 0 32 32" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="pl-1 text-black">Call for paper</span>
                    </div>
                </a>
            </li>
            <li class="menu nav-item">
                <a href="{{ route('admin.about') }}" class="nav-link group"
                    :class="{'active' : activeMenu === 'editorial_board'}">
                    <div class="flex pl-5 items-center">
                        <svg class="w-5 h-5" width="32" height="32" viewbox="0 0 32 32" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <span class="pl-1 text-black">Editorial Board</span>
                    </div>
                </a>
            </li>

            <li class="menu nav-item">
                <a href="{{ route('admin.slider') }}" class="nav-link group"
                    :class="{'active' : activeMenu === 'slider'}">
                    <div class="flex pl-5 items-center">
                        <svg class="w-5 h-5" width="32" height="32" viewbox="0 0 32 32" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <span class="pl-1 text-black">Slider</span>
                    </div>
                </a>
            </li>
            ...
            <li class="menu nav-item">
                <a href="javaScript:;" class="nav-link group active text-black"
                    :class="{'active' : activeMenu === 'authors'}"
                    @click="activeMenu === 'authors' ? activeMenu = null : activeMenu = 'authors'">
                    <div class="text-black/50 w-4 h-4 flex items-center justify-center"
                        :class="{'!rotate-90' : activeMenu === 'authors'}">
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="pl-1">Authors</span>
                    </div>
                </a>
                <ul x-cloak x-show="activeMenu === 'authors'" x-collapse
                    class="sub-menu flex flex-col gap-1 text-black">
                    <li><a href="email.html">Guidelines</a></li>
                    <li><a href="chat.html">Paper Templates</a></li>
            ...
            <li class="menu nav-item">
                <a href="javaScript:;" class="nav-link group active text-black"
                    ...
                    @click="activeMenu === 'apps' ? activeMenu = null : activeMenu = 'articles'">
                    <div class="text-black/50 w-4 h-4 flex items-center justify-center"
                        :class="{'!rotate-90' : activeMenu === 'articles'}">
                        <svg width="6" height="10" viewbox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M0.659675 9.35355C0.446775 9.15829 0.446775 8.84171 0.659675 8.64645L4.25 5.35355C4.4629 5.15829 4.4629 4.84171 4.25 4.64645L0.659675 1.35355C0.446776 1.15829 0.446776 0.841709 0.659675 0.646446C0.872575 0.451184 1.21775 0.451185 1.43065 0.646446L5.02098 3.93934C5.65967 4.52513 5.65968 5.47487 5.02098 6.06066L1.43065 9.35355C1.21775 9.54882 0.872574 9.54882 0.659675 9.35355Z"
                                fill="currentcolor" />
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="pl-1">Acticles</span>
                    </div>
                </a>
                <ul x-cloak x-show="activeMenu === 'articles'" x-collapse
                    class="sub-menu flex flex-col gap-1 text-black">
                    <li><a href="email.html">Current Article</a></li>
                    <li><a href="chat.html">Paper Templates</a></li>

                </ul>
            </li>
            <h2 class="pl-3 my-2 text-black/60 text-sm">
            ...
            <li class="menu nav-item">
                <a href="javaScript:;" class="nav-link group text-black"
            ...
            <li class="menu nav-item">
                <a href="charts.html" class="nav-link group" :class="{'active' : activeMenu === 'charts'}">
                    <div class="flex pl-5 items-center">
                        ...
                        <span class="pl-1 text-black">Charts</span>
                    </div>
                </a>
            </li>
            <li class="menu nav-item">
                <a href="widgets.html" class="nav-link group" :class="{'active' : activeMenu === 'widgets'}">
                    <div class="flex pl-5 items-center">
                        ...
                        <span class="pl-1 text-black">Widgets</span>
                    </div>
                </a>
            </li>
            <li class="menu nav-item">
                <a href="font-icons.html" class="nav-link group" :class="{'active' : activeMenu === 'fonticons'}">
                    <div class="flex pl-5 items-center">
                        ...
                        <span class="pl-1 text-black">Font Icons</span>
                    </div>
                </a>
            </li>
            <li class="menu nav-item">
                <a href="drag-and-drop.html" class="nav-link group" :class="{'active' : activeMenu === 'drag'}">
                    <div class="flex pl-5 items-center">
                        ...
                        <span class="pl-1 text-black">Drag & Drop</span>
                    </div>
                </a>
            </li>
            <h2 class="pl-3 my-2 text-black/40 text-sm">
            ...
            <li class="menu nav-item">
                <a href="tables.html" class="nav-link group" :class="{'active' : activeMenu === 'table'}">
                    <div class="flex pl-5 items-center">
                        ...
                        <span class="pl-1 text-black">Tables</span>
                    </div>
                </a>
            </li>
            <li class="menu nav-item">
                <a href="datatables.html" class="nav-link group" :class="{'active' : activeMenu === 'datatable'}">
                    <div class="flex pl-5 items-center">
                        ...
                        <span class="pl-1 text-black">DataTables</span>
                    </div>
                </a>
            </li>
            <li class="menu nav-item">
                <a href="javaScript:;" class="nav-link group" :class="{'active' : activeMenu === 'forms'}"
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="pl-1 text-black">Forms</span>
                    </div>
                </a>
            ...
            <li class="menu nav-item">
                <a href="javaScript:;" class="nav-link group" :class="{'active' : activeMenu === 'users'}"
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="pl-1 text-black">Users</span>
                    </div>
                </a>
            ...
            <li class="menu nav-item">
                <a href="javaScript:;" class="nav-link group" :class="{'active' : activeMenu === 'pages'}"
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="pl-1 text-black">Pages</span>
                    </div>
                </a>
            ...
            <li class="menu nav-item">
                <a href="javaScript:;" class="nav-link group" :class="{'active' : activeMenu === 'authentication'}"
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="pl-1 text-black">Authentication</span>
                    </div>
                </a>
            ...
            <li class="menu nav-item">
                <a href="https://webonzer.com/documentation/documentation.html" class="nav-link group"
                    ...
                    <div class="flex pl-5 items-center">
                        ...
                        <span class="pl-1 text-black">Documentation</span>
                    </div>
                </a>
            </li>
        </ul>
